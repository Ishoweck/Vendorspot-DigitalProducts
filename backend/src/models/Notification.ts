...
export interface INotification extends Document {
  ...
  type: "ORDER_CREATED" | "ORDER_CONFIRMED" | "ORDER_SHIPPED" | "ORDER_DELIVERED" | 
        ...
        "REVIEW_ADDED" | "VENDOR_APPROVED" | "SYSTEM_ANNOUNCEMENT" | "PROMOTION";
  title: string;
  message: string;
  data?: any;
  isRead: boolean;
  category: "ORDER" | "PAYMENT" | "PRODUCT" | "REVIEW" | "ACCOUNT" | "SYSTEM" | "PROMOTION";
...
const notificationSchema = new Schema<INotification>({
  ...
  category: {
    type: String,
    enum: ["ORDER", "PAYMENT", "PRODUCT", "REVIEW", "ACCOUNT", "SYSTEM", "PROMOTION"],
    required: true
  },
  priority: {
    type: String,
